...
public class EgovFileTool {
     ...
     */
    @SuppressWarnings("unchecked")
    public static synchronized Vector parsFileByChar(String parFile, String parChar, int parField) throws Exception {
     ...
     */
    @SuppressWarnings("unchecked")
    public static synchronized boolean cmprFilesByContent(String cmprFile1, String cmprFile2) throws Exception {
     ...
     * @exception Exception
     */
    public static synchronized String getMountLc(String file) throws Exception {
     ...
     * @exception Exception
     */
    public static synchronized String getOwner(String file) throws Exception {
	...
	try {
	    ...
	    if (srcFile.exists()) {
			...
			if(cmdStr != null && parentPath != null){
     ...
     * @exception Exception
     */
    public static synchronized String getAccess(String file) throws Exception {
			    ...
			    //프로세스 실행 성공시 결과 확인
					...
					while (b_out.ready()) {
					    if (!result) { //result != true
							...
							if (access != null){
								if(!"".equals(access) && access.length() <= MAX_STR_LEN) {
									result = true;
								    break;
								}	
							}
     ...
     */
    public synchronized static boolean moveFile(String originalDirPath, String targetDirPath) throws Exception {
     ...
     *         않았으면 false)
     */
    public static synchronized boolean startDirectoryMonitering(String targetDirPath) throws Exception {
     ...
     *         않았으면 false)
     */
    public static synchronized boolean stopDirectoryMonitering(String targetDirPath) throws Exception {
