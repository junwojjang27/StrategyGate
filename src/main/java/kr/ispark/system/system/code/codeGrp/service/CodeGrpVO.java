...
*	1	현걸욱		2018-1-26
**************************************************************************/
package kr.ispark.system.system.code.codeGrp.service;
...
@Getter @Setter
public class CodeGrpVO extends CommonVO {
	...
	private List<CodeGrpVO> LangList;
	...
	private List<CodeGrpVO> gridDataList;
}
