/*************************************************************************
* CLASS 명	: CompareMetricGrpServiceIpml
* 작 업 자	: kimyh
* 작 업 일	: 2018-05-02
...
@Service
public class CompareMetricGrpServiceImpl extends EgovAbstractServiceImpl {
	@Resource
	private CompareMetricGrpDAO compareMetricGrpDAO;
	...
	public List<CompareMetricGrpVO> selectMetricGrpList(CompareMetricGrpVO searchVO) throws Exception {
		return compareMetricGrpDAO.selectMetricGrpList(searchVO);
	}
	...
	public List<CompareMetricGrpVO> selectList(CompareMetricGrpVO searchVO) throws Exception {
		return compareMetricGrpDAO.selectList(searchVO);
	}
	...
	public CompareMetricGrpVO selectScoreAnalysis(CompareMetricGrpVO searchVO) throws Exception {
		return compareMetricGrpDAO.selectScoreAnalysis(searchVO);
	}
	...
	public List<CompareMetricGrpVO> selectMonthlyTrend(CompareMetricGrpVO searchVO) throws Exception {
		return compareMetricGrpDAO.selectMonthlyTrend(searchVO);
	}
}
