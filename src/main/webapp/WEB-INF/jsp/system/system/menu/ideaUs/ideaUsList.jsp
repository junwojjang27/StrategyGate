    ...
    $(function () {
        $("#list").jqGrid({
            ...
            colModel: [
                ...
                {name: "findUseYn", index: "findUseYn", width: 30,  hidden: true},
        ...
        <div class="tbl-type02">
            <table summary="">
                ...
                <tr>
                    ...
                    <th scope="row"><label for="useYn"><spring:message code="word.useYn"/></label><span
                            class="red">(*)</span></th>
                    <td>
                        <form:select path="useYn" class="select wx80" items="${codeUtil:getCodeList('011')}"
                                     itemLabel="codeNm" itemValue="codeId">
                        </form:select>
                    </td>
                </tr>
