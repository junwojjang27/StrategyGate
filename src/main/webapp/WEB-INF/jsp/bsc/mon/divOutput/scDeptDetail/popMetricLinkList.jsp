...
$(function(){
	...
	$("#popMetricLinkList").jqGrid({
		url			:	"${context_path}/bsc/mon/divOutput/scDeptDetail/popMetricLinkList_json.do",
		postData	:	getFormData("popMetricLinkForm"),
		width		:	"820",
		height		:	"300",  
		colModel	:	[
						{name:"metricId",		index:"metricId",		hidden:true},
						{name:"metricNm",		index:"metricNm",		width:220,	align:"left",	label:"<spring:message code="word.metric" />"},
						...
						{name:"value",			index:"value",			width:150,	align:"right",	label:"<spring:message code="word.actual" />"},
						{name:"score",			index:"score",			width:150,	align:"right",	label:"<spring:message code="word.score" />"}
						],
...
<div class="popup">
<form:form commandName="searchVO" id="popMetricLinkForm" name="popMetricLinkForm" method="post">
	...
	<table id="popMetricLinkList"></table>
